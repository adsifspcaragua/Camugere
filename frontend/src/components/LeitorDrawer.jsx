  ...
  return (
    <>
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-label={isEdit ? "Editar Leitor" : "Novo Leitor"}
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-surface-900 dark:text-white">
                {isEdit ? "Editar Leitor" : "Novo Leitor"}
              </h2>
              <p className="text-base text-surface-400 dark:text-surface-500">
                {isEdit ? "Atualizar dados do leitor" : "Cadastrar novo leitor"}
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col">
          <div className="flex-1 space-y-5 overflow-y-auto px-6 py-6 scrollbar-thin">
            ...
            <div>
              <label className="mb-2 flex items-center gap-2 text-base font-medium text-surface-700 dark:text-surface-300">
                <Phone size={18} className="text-surface-400" /> Telefone{" "}
                <span className="text-sm text-surface-400">(opcional)</span>
              </label>
              <input
                type="tel"
                value={telefone}
